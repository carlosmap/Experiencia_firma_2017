...
//echo "ingresaa 2222 ";							
		...
		{		
				...
				$sqlIn1 = $sqlIn1 . "( 
				id_proyecto, certificado_SEVEN,  codigo, codigo_SEVEN, numero_contrato,  id_tipo_proyecto, id_moneda, TRM, id_tipo_ejecucion, id_empresa, id_forma_pago, usuarioGraba,  fechaGraba) values ( ".$id_proye." ,	 '".$SEVE."',	
...
function valida()
{
 ...
 <?php
	...
	if($Moneda==2)
		echo 'var campos_tex = ["ProyL","Cod","SEVE","SEVENN","Cliente","NoContrato","Finicio","Final","Pais","Depto","Municipio","Ejecucion","Empresa","TipoP","Moneda","Valor","FPago","TRM"];	';
	else
		echo 'var campos_tex = ["ProyL","Cod","SEVE","SEVENN","Cliente","NoContrato","Finicio","Final","Pais","Depto","Municipio","Ejecucion","Empresa","TipoP","Moneda","Valor","FPago"];	';		
?>  
