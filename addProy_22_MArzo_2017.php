...
//echo $sqlIn1."<br>";		
		if($cursorIn1!="")
		{
			...
			$sqlIn1 ="insert into EFClientes_Proyectos (id_cliente,id_proyecto) values( ".$Cliente.", ".$id_proye.")";
			$cursorIn1 = mssql_query($sqlIn1);					
//echo $sqlIn1."<br>";					
			if($cursorIn1!="")
			{
							...
							{				
								...
								{	
									...
									if($Ejecucion==1)	
									{
										...
										values(1, '".$id_proye."', ".$Empresa.", 100, 1, ".$Valor.", ".$Valor.", ".$Valor.", 1, " . $_SESSION["sesUnidadUsuario"] . ",getdate() )";
										$cursorIn1 = mssql_query($sqlIn1);																
									}
