...
if($datos_proffo=mssql_fetch_array($cur_proffo))
{
	...
	$Finicio=$datos_proffo["fecha_inicios"];
...
//echo $Prorroga.",'".$Finicio."','".$Final."',".$Documento." ,".$Valor.",'".$Observaciones."'," . $_SESSION["sesUnidadUsuario"] . ",getdate() <br>"  ;
...
//alert(" -- "+document.getElementById("Finicio").value+ " *** "+document.getElementById("FechaIniProy").value) ;	
	...
	if( (document.getElementById("Finicio").value!="") && (document.getElementById("Finicio").value!="") )
	{				
