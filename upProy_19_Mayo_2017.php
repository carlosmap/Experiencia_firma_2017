...
function valida()
{
  ...
  <?php
	...
	if($Moneda==2)
		echo 'var campos_tex = ["ProyL","Cod","SEVE","SEVENN","Cliente","NoContrato","Finicio","Final","Pais","Depto","Municipio","Ejecucion","Empresa","TipoP","Moneda","Valor","FPago","TRM","Estado"];	';
	else
		echo 'var campos_tex = ["ProyL","Cod","SEVE","SEVENN","Cliente","NoContrato","Finicio","Final","Pais","Depto","Municipio","Ejecucion","Empresa","TipoP","Moneda","Valor","FPago","Estado"];	';		
?>  
...
if($recarga=="")
{
	...
	$sql_info_proy="select EFProyectos.*, nombre_largo_proyecto, nombre_corto_proyecto, EFClientes_Proyectos.id_cliente, EFEstados_Proy_Proyectos.id_estado_proy, EFEstados_Proy_Proyectos.observaciones ,EFUbicacion_Proyectos.*,  CONVERT(varchar, EFFechas_Proyecto.fecha_inicio_proyecto,101) fecha_inicio_proyecto, CONVERT(varchar, EFFechas_Proyecto.fecha_final_proyecto,101)  fecha_final_proyecto, EFValores_Contrato.valor_contrato
	from EFProyectos
...
<form id="formulario" name="formulario" method="POST">
  ...
  <div class="form-group" id="divCliente">
    ...
    <select class="form-control" disabled  onChange="document.formulario.submit();">
    ...
    ?>  
     ...
     <input type="hidden" id="TipoP" name="TipoP" value="<?=$TipoP ?>" >
...
<?php
	//SI EL TIPO DE PROYECTO ES NO FACTURABLE
	//SE DESABILITARAN LOS CAMPOS Tipo de proyecto Y Estado
	if($TipoP==5)
	{
...
?>    
   ...
   <div class="form-group" id="divFPago"><label for="">Tipo de facturaci&oacute;n</label>
     <select class="form-control" id="FPago" name="FPago" <?=$dis ?>>
      <option selected value="">Seleccione el tipo de facturación</option>        
    <?php
