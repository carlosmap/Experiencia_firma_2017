	...
	if($acc==2)
	{
		...
		//echo "cant_nom = ".$cant_nom." cant_veri_seven = ".$cant_veri_seven."<br>";
			if(($cant_nom==0) && ($cant_veri_seven==0) )
			{
				...
				$sqlIn1 = $sqlIn1 . " certificado_SPEEDWARE='".$SPEE."',  certificado_SEVEN='".$SEVE."', codigo='".$Cod."', codigo_SEVEN='".$SEVENN."', codigo_SEVEN_anterior='".$SEVENA."', numero_contrato='".$NoContrato."',  id_tipo_proyecto=".$TipoP.", id_moneda=".$Moneda.", TRM=".$TRM.", id_tipo_ejecucion=".$Ejecucion.", id_empresa=".$Empresa.", id_forma_pago=".$FPago."  ";
