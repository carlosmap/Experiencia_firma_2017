                  ...
                  <?php
					...
					if(($sec=="1-1-1")|| ($sec==""))
					{
						...
						{						
							...
							{
?>                  
                      <th width="1%" rowspan="16" style="vertical-align:middle;">
...
?>                     
                          <th width="1%" rowspan="16" style="vertical-align:middle; " >
                             <i class="glyphicon glyphicon-remove" style="cursor:pointer; " title="No se permite eliminar el proyecto, porque existe informaci&oacute;n asociada de prorrogas, adicionales, suspensiones, reanudaciones, liquidaciones, consorcios, valores facturados, informaci&oacute;n adicional, encargados del proyecto o documentos de recepci&oacute;n. "> </i> 		
                          </th>
<?php							
							}
						}
...
?>                   
                ...
                <tr>
                  ...
                  <td ><?=$datos_info["observaciones"] ?></td>
                </tr>                
              </thead>
              <tbody>
