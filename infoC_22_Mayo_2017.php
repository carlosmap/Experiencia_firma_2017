...
<?
...

		{
			...
			$sql_certi="select * from EFProyectos where id_proyecto=".$Proy." ";					
			$cur_certi= mssql_query($sql_certi);		
			$datos_certi=mssql_fetch_array($cur_certi);
			$cant_filas=2;	
			
			$sql_doc="select * from EFDocumentos_Recepcion_Certificado where id_proyecto=".$Proy;
...
?>	
                	<a href="#" onClick="MM_openBrWindow('upCertificado.php?Proy=<?=$Proy ?>&acc=2','EF2','scrollbars=yes,resizable=yes,width=780,height=420');"> <i class="glyphicon glyphicon-pencil"></i> </a>
<?php
...
<?php
	...
	<?php
					...
					if(($datos_certi["fecha_solicitud_certificado"]!="") || ($datos_certi["fecha_recepcion_certificado"]!="") || ($datos_certi["fecha_facturacion_certificado"]!=""))
					{
							...
							{
		?>                                
							<a href="#"  onClick="MM_openBrWindow('upCertificado.php?Proy=<?=$Proy ?>&acc=3','EF2','scrollbars=yes,resizable=yes,width=780,height=420');" > <i class="glyphicon glyphicon-remove"> </i> </a>
		<?php
							}
							else
							{
...
?>                
            ...
            <tr>
                <td><?=$datos_certi["fecha_solicitud_certificado"] ?></td>
                <td><?=$datos_certi["fecha_recepcion_certificado"] ?></td>
                <td><?=$datos_certi["fecha_facturacion_certificado"] ?></td>
             </tr>
<?php
...
/*
					...
					if( ($_SESSION["sesPerfilUsuarioExpFir"]==1) || ($_SESSION["sesPerfilUsuarioExpFir"]==2) )			    
					{
						...
						{						
?>	                      
                      <td width="1%"><a href="#"  onClick="MM_openBrWindow('delDocumento.php?Proy=<?=$Proy ?>&doc=<?=$datos_doc["id_documento_recepcion_certificado"] ?>','EF2','scrollbars=yes,resizable=yes,width=580,height=420');" > <i class="glyphicon glyphicon-remove"> </i> </a></td>
<?php
						}
					}
*/					
...
?>	                    
                    <tr>
                        <td colspan="4" align="right"><button type="button" class="btn btn-primary" onClick="MM_openBrWindow('addDocumento.php?Proy=<?=$Proy ?>','EF2','scrollbars=yes,resizable=yes,width=580,height=420');" >Nuevo Documento</button></td>
                     </tr>  
<?php
					}
				}
...
?>	      
            <tr>
                <td colspan="6" align="right">              <button type="button" class="btn btn-primary" onClick="MM_openBrWindow('addCertificado.php?Proy=<?=$Proy ?>','EF2','scrollbars=yes,resizable=yes,width=780,height=420');" >Nuevo Certificado</button></td>
             </tr>
<?php
					}
				}
