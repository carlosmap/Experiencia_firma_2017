...
<?php
	...
	if($TipoPAnt==5)
	{
		...
		echo '<input type="hidden" id="TipoP" name="TipoP" value="'.$Estado.'" >';
	}
/*
	$disb="";
...
*/		
?>    
    <select class="form-control"  <?=$dis_tipo_rpoy ?> id="TipoP" name="TipoP" onChange="document.formulario.submit();" <?=$dis ?> >
